...
public class ModelDuckTests {
	...
	public void testInheritedSwim() {
		...
		assertTrue(DuckTest.inheritedSwim(modelDuck));
	}
	...
	public void testDefaultFlyBehavior(){
		...
		assertTrue(DuckTest.flyBehavior(modelDuck, expected));
	}
	...
	public void testDefaultQuackBehavior(){
		...
		assertTrue(DuckTest.quackBehavior(modelDuck, expected));
	}
	...
	public void testCustomDisplayImplementation(){
		...
		assertTrue(DuckTest.displayImplementation(modelDuck, expected));
	}
}
